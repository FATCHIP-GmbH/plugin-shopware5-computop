...
class AfterAccountPaymentActionHook extends AbstractAccountSubscriber
{
    /**
    ...
    public static function getSubscribedEvents()
    {
        ...
        return ['Shopware_Controllers_Frontend_Account::paymentAction::after' => 'account__paymentAction__after'];
    }
