...
{block name='frontend_register_index_registration'}
    ...
    <div id="fatchipFCSAmazonInformation" hidden
         ...
         data-fatchipFCSAmazonisPhoneMandatory = '{$fatchipFCSAmazonisPhoneMandatory}'
         data-fatchipFCSAmazonisBirthdayMandatory = '{$fatchipFCSAmazonisBirthdayMandatory}'
         data-fatchipFCSAmazonBirthdaySingleField = '{config name="birthdaySingleField"}'
    ></div>
