...
*}
    ...
    <div>
        {block name="frontend_checkout_payment_fatchip_computop_afterpay_installment_socialsecuritynumber_label"}
            <p class="none">
                <label for="fatchip_computop_afterpay_socialsecuritynumber">{$FatchipCTPaymentData.SSNLabel}</label>
            </p>
        {/block}

        {block name="frontend_checkout_payment_fatchip_computop_afterpay_socialsecuritynumber_input"}
            <input name="FatchipComputopPaymentData[fatchip_computop_afterpay_installment_socialsecuritynumber]" type="text"
            ...
            class="payment--field is--required{if $error_flags.fatchip_computop__afterpay_socialsecuritynumber} has--error{/if}"
