<div class="fatchip-computop-payment-klarna-form payment--form-group">
    {block name="frontend_checkout_payment_fatchip_computop_laschtrift_bank_label"}
        <p class="none">
            <label for="fatchip_computop_lastschrift_bank">{s name='Bank' namespace='frontend/FatchipCTPayment/translations'}Kreditinstitut{/s}</label>
        </p>
    {/block}
    ...
    {block name="frontend_checkout_payment_fatchip_computop_laschtrift_kontoinhaber_label"}
        <p class="none">
            <label for="fatchip_computop_lastschrift_bank">{s name='AccountHolderLabel' namespace='frontend/FatchipCTPayment/translations'}Kontoinhaber{/s}</label>
        </p>
    {/block}
    ...
    {block name="frontend_checkout_payment_fatchip_computop_laschtrift_iban_label"}
        <p class="none">
            <label for="fatchip_computop_lastschrift_bank">IBAN</label>
        </p>
    {/block}
