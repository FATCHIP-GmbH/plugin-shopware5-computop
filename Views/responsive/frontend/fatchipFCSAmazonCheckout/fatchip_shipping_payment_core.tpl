...
<div class="confirm--outer-container">
    <form id="shippingPaymentForm" name="shippingPaymentForm" method="post" action="{url controller='FatchipFCSAmazonCheckout' action='saveShippingPayment' sTarget='FatchipFCSAmazonCheckout' sTargetAction='index'}" class="payment">
...
-->
                    <input type="hidden" name="payment" value="{$fatchipFCSAmazonpayID}" />
